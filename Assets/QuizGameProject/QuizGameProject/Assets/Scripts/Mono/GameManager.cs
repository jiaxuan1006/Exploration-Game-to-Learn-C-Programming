...
public class GameManager : MonoBehaviour {
    ...
    [SerializeField] private GameObject highScoreBadge; // UI element for High Score Badge
    ...
    void Start()
    {
        ...
        // Ensure the high score badge is hidden at the start
        if (highScoreBadge != null)
        {
    ...
    private void SetHighscore()
    {
        ...
        int finalScore = events.CurrentFinalScore;
        FindObjectOfType<APISystem>().InsertPlayerActivity(PlayerPrefs.GetString("username"), "score_Task2", "add", finalScore.ToString());
    }
